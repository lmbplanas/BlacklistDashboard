...
const Header = ({ lastUpdated, onSearch, onRefreshComplete }) => {
  ...
  const handleRefresh = async () => {
    ...
    try {
      ...
      }, 500); // Keep spinner visible briefly for feedback
    }
  };
            ...
            <Col xs={12} md={4} className="text-md-end">
              <div className="last-updated-container d-flex align-items-center justify-content-md-end">
                ...
                <span className="last-updated-text">
                  Last Updated: {lastUpdated ? moment(lastUpdated).format('YYYY-MM-DD HH:mm') : 'Never'}
                </span>
              </div>
            </Col>
          </Row>
